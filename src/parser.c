...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [21] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_repeat1, 2, 0, 0), SHIFT_REPEAT(3),
  [24] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_repeat1, 2, 0, 0), SHIFT_REPEAT(31),
  [27] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_repeat1, 2, 0, 0), SHIFT_REPEAT(37),
  [30] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_repeat1, 2, 0, 0), SHIFT_REPEAT(42),
  [33] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_repeat1, 2, 0, 0), SHIFT_REPEAT(45),
  [36] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_disassembly_section, 4, 0, 1),
  [38] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_disassembly_section, 4, 0, 1), SHIFT(39),
  [41] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_disassembly_section, 4, 0, 1), SHIFT(41),
  [44] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_disassembly_section, 4, 0, 1), SHIFT(45),
  [47] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_disassembly_section_repeat1, 2, 0, 0),
  [49] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_disassembly_section_repeat1, 2, 0, 0), SHIFT_REPEAT(39),
  [52] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_disassembly_section_repeat1, 2, 0, 0), SHIFT_REPEAT(41),
  [55] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_disassembly_section_repeat1, 2, 0, 0), SHIFT_REPEAT(45),
  [58] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_disassembly_section, 5, 0, 1),
  [60] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_disassembly_section, 5, 0, 1), SHIFT(39),
  [63] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_disassembly_section, 5, 0, 1), SHIFT(41),
  [66] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_disassembly_section, 5, 0, 1), SHIFT(45),
  [69] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__instruction_and_location, 1, 0, 0),
  [71] = {.entry = {.count = 1, .reusable = true}}, SHIFT(54),
  [73] = {.entry = {.count = 1, .reusable = true}}, SHIFT(44),
  [75] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__instruction_and_location, 1, 0, 0),
  [77] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_location, 3, 0, 0),
  [79] = {.entry = {.count = 1, .reusable = true}}, SHIFT(50),
  [81] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_source_location, 3, 0, 0),
  [83] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__instruction_and_location, 2, 0, 0),
  [85] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__instruction_and_location, 2, 0, 0),
  [87] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_code_location, 5, 0, 0),
  [89] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_code_location, 5, 0, 0),
  [91] = {.entry = {.count = 1, .reusable = false}}, SHIFT(39),
  [93] = {.entry = {.count = 1, .reusable = false}}, SHIFT(41),
  [95] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_file_offset, 5, 0, 0),
  [97] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_file_offset, 5, 0, 0),
  [99] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_code_location, 3, 0, 0),
  [101] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_code_location, 3, 0, 0),
  [103] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_disassembly_section_label, 3, 0, 0),
  [105] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_disassembly_section_label, 3, 0, 0),
  [107] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_label_line, 2, 0, 0),
  [109] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_label_line, 2, 0, 0),
  [111] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_memory_offset, 4, 0, 0),
  [113] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_memory_offset, 4, 0, 0),
  [115] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__instruction_and_location, 3, 0, 0),
  [117] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__instruction_and_location, 3, 0, 0),
  [119] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_memory_offset, 5, 0, 0),
  [121] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_memory_offset, 5, 0, 0),
  [123] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_header, 5, 0, 0),
  [125] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_header, 5, 0, 0),
  [127] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_location, 4, 0, 0),
  [129] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_source_location, 4, 0, 0),
  [131] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_discriminator, 4, 0, 0),
  [133] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_discriminator, 4, 0, 0),
  [135] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_machine_code_bytes, 2, 0, 0),
  [137] = {.entry = {.count = 1, .reusable = false}}, SHIFT(52),
  [139] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_machine_code_bytes, 2, 0, 0),
  [141] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_machine_code_bytes, 1, 0, 0),
  [143] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_machine_code_bytes, 1, 0, 0),
  [145] = {.entry = {.count = 1, .reusable = false}}, SHIFT(7),
  [147] = {.entry = {.count = 1, .reusable = false}}, SHIFT(20),
  [149] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_machine_code_bytes_repeat1, 2, 0, 0),
  [151] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_machine_code_bytes_repeat1, 2, 0, 0), SHIFT_REPEAT(52),
  [154] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_machine_code_bytes_repeat1, 2, 0, 0),
